...
public class ManageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        typeCB.getItems().addAll("argent", "Matériel");
        ...
        if (currentDon != null) {
            ...
            try {
                typeCB.setValue(currentDon.getType());
        ...
        if (controleDeSaisie()) {
            ...
            if (currentDon == null) {
                ...
                if (DonService.getInstance().edit(don)) {
                    ...
                    try {
                        // Charger le fichier FXML du nouvel interface
                        FXMLLoader loader = new FXMLLoader(getClass().getResource(Constants.FXML_FRONT_DISPLAY_ALL_DON));
                        Parent root = loader.load();
    ...
    private boolean controleDeSaisie() {
        ...
        if (typeCB.getValue() == null) {
            AlertUtils.makeInformation("Veuillez choisir un type");
            return false;
        }
